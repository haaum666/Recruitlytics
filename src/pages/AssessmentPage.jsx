            ...
            {questions.map((question, index) => {
              ...
              return (
                <AccordionItem key={question.id} value={question.id}>
                  <AccordionTrigger className="flex justify-between items-center w-full p-4 rounded-lg hover:bg-gray-100 transition-colors duration-200 cursor-pointer no-underline [&[data-state=open]]:bg-gray-100">
